...
function cairn(parentStyler, sheet = {}, stylesTransformer = noopTransformer) {
  ...
  const styler = mergedStyle(parentStyler, currentStyler);

  // Add the extend function for chaining
  styler.extend = (sheet) => cairn(styler, sheet, stylesTransformer);
